...
- Mit **Inline-Methode**: ![Screenshot mit Inline-Methode](docs/bilder/home/capture-d-ecran.png)
...
[logo_2]: docs/bilder/home/capture-d-ecran.png "corehub.net Email Screenshot"
...
- Overfitting = The problem of overfitting occurs when a model is **too complex and captures too much detail** from the _training_ data. This can lead to the model being unable to generalize to new, unseen data.
