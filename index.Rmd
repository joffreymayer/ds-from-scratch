...
[This Youtube-Video](https://www.youtube.com/watch?v=HfTXHrWMGVY&t=1m52s) from `WebDevSimplified` will show you how to do it =)
...
![Sankey-Diagram, in order to answer the question: Which one has the Momentum?](./bilder/momentum-tensorflow-vs-pytorch)
...
- <u>Tutorial (Artikel von _Towards-Datascience_): [Build Animated R-Visualizations](https://towardsdatascience.com/how-to-build-animated-charts-like-hans-rosling-doing-it-all-in-r-570efc6ba382)