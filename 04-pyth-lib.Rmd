...
Dieses <a href="https://joffreymayer.github.io/ds-from-scratch/python-mustercodes.html" target="_blank">Juypiter Notebook ZF</a>.
...
The following `DataFrame` was build with many `Series`-Objects:
...
```
df.to_csv('Your_FileName.csv', index = True) # this will be saved into your 'wd'
```
...
#### Date-Range in 15-Minutes Abstand
