...
_Wenn du nämlich die obige Frage mit "NEIN" beantwortest, dann brauchst du schon gar nicht mit dem Projekt zu beginnen, denn es wäre ineffizient ;)
...
Hier mein Vorgehen, um jedes mögliche DS-Problem zu lösen, **_after_ you came to the conclusion: "Yes, the data looks OK. We can try to solve the problem!"**
