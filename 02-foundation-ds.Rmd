...
## <a name="key-1">Questions you need to answer when starting a new Project</a>
...
*Es geht am Anfang um die Gesamtübersicht und noch nicht um die Details // Eigenheiten im Code oder im Datensatz! Am wichtigsten ist es, dass du [diese Fragen](#key-1) zunächst beantworten kannst, wenn du das Notebook liest.*
