...
![Beispiel einer Tages-Saisonalität](./bilder/econ/tages-seasonality.jpg)

  - <u>Example 2</u>: You see an "Buckel" for each day of the weak --> _Weekly Seasonality_
  
![Beispiel einer Wochen-Saisonalität](./bilder/econ/weekly-seasonality.jpg)
  
  - <u>Example 3</u>: You see an the same "Abwärtsbewegung" **for the first 3 months of the year(!)** --> _Monthly Seasonality_
 
![Beispiel einer Monats-Saisonalität](./bilder/econ/monats-seasonality.jpg) 
...
![Hier ein Beispiel eines partiellen Auto-Korrelations Plot](./bilder/econ/partielle-auto-korr-plot.jpg)
