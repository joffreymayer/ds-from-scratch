...
- Multivariate Forecasting: Verwende - **<u>nebst</u> vergangenen Preise** der (eigenen Zeitreihe) - auch noch **andere Zeitreihen**, um die Preise der Zukunft zu forecasten.
- **<u>What is Seasonality?</u>**: A **repeating pattern** <u>within a year</u>.
  - <u>Example 1</u>: You see a "Buckel" every weekend --> _Weekend Seasonality_
  - <u>Example 2</u>: You see an "s-shape" for each day of the weak --> _Daily Seasonality_
- **<u>What is a Cycle?</u>**: This is NOT the same thing as seasonality.
Cycles **take place over the course of several year**, rather than _within_ a year for seasonality. Generally, **cycles are not predictable**.
...
![Darstellung des Data Leakage Problems bei Time Series: das Modell kann leichte Vorhersagen machen, weil es Teile der Zukunft sieht! xD](./bilder/econ/data-leakage-problem-ts.jpg)
 - __Berechnung der Validation-Error__:
 
![Visuelle Darstellung, wie der verschiedenen Validierungs-Fehler (MAPE, MAE oder RMSE) berechnet werden auf dem Trainingsset. Vergesse nicht, dass jeweils bloss ein durchschnittswert pro Tabular-Regression ausgerechnet wird!](./bilder/econ/validation-error-ts.jpg) 
